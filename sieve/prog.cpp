...
long strike(bool composite[], long begin, long incr, long end)
{
    long i;
...
int main()
{
    cout << "Cache Unfreindly sieve: " << cacheUnfriendlySieve(10000000) << " ,time = " << t << endl;
    cout << "Cache Friendly sieve: " << cacheFriendlySieve(10000000) << " ,time = " << t << endl;
    cout << "Parallel sieve: " << parallelSieve(10000000) << " ,time = " << t << endl;
